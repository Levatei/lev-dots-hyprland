...
> [!NOTE]
> New Features:
> - **RU keyboard layout**: `us,ru` with `Alt+Shift`
> - **NVIDIA GPU in the top bar**: load circle next to CPU/RAM + popup with load, VRAM used/total and temperature
...
> The environment consists of the following applications:
> [in English](/APPS.en.md) | [на русском](/APPS.md) 
